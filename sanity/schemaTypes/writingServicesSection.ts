...
export const writingServicesSection = defineType({
  name: "writingServicesSection",
  title: "✍️ Writing Services Section",
  type: "document",
  groups: [
    { name: "header", title: "Section Header", default: true },
    { name: "features", title: "Services Offered" },
  ...
  fields: [
    ...
    defineField({
      ...
      type: "array",
      description: "List of writing services you offer",
      of: [
        {
          type: "object",
          fields: [
