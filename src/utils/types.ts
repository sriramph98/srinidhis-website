  ...
  Hero: [
    {
      ...
      description:
        "From landing your dream job to mastering customer success, I provide expert consulting, strategic guidance, and powerful writing services. Elevate your career, refine your brand, and connect with the right opportunities—let's make your success story unforgettable!",
      name: "Srinidhi Narayana",
      profileImage: ["/images/1694671350246.jpeg"],
    },
  ],
  LinkedIn: [
    {
      ...
      description:
        "Transform your LinkedIn presence with a professionally optimized profile that attracts recruiters and showcases your expertise.",
      images: ["/images/linkedin-optimization.png"],
    },
  ],
  LinkedInFeatures: [
    {
      ...
      description:
        "Craft a compelling headline and summary that captures attention and showcases your expertise.",
    ...
    },
    {
      ...
      description:
        "Highlight your key accomplishments and experience with impactful metrics and results.",
    ...
    },
    {
      ...
      title: "SEO & Keywords",
      description:
        "Optimize your profile with industry-relevant keywords to improve visibility in recruiter searches.",
  ...
  Resume: [
    {
      ...
      description:
        "Get a professionally written resume that highlights your achievements and helps you stand out in the job market.",
    },
  ],
  ResumeFeatures: [
    {
      ...
      description:
        "Ensure your resume passes through Applicant Tracking Systems with an optimized format and relevant keywords.",
    ...
    },
    {
      ...
      description:
        "Showcase your impact with quantifiable achievements and compelling success stories.",
    ...
    },
    {
      ...
      description:
        "Incorporate relevant industry keywords to match job requirements and improve visibility.",
    ...
    },
    {
      ...
      description:
        "Clean, modern design that's easy to read and highlights your key qualifications.",
  ...
  CoachingFeatures: [
    {
      ...
      images: ["/images/markus-winkler-IrRbSND5EUc-unsplash.jpg"],
    },
    {
      type: "coaching",
      title: "Customer Success Plans for Small Businesses",
      description: "Create effective customer success strategies",
      images: ["/images/cytonn-photography-n95VMLxqM2I-unsplash.jpg"],
    },
  ],
  JobSearch: [
    {
      ...
      description:
        "Navigate your job search with confidence using my proven strategies. I'll help you target the right opportunities, optimize your applications, and prepare for interviews effectively.",
      images: ["/images/job-search-strategy.png"],
    },
  ],
  JobSearchFeatures: [
    {
      ...
      description:
        "Tailored guidance to help you navigate job boards, networking, and direct outreach to potential employers.",
      icon: "M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z",
    },
    {
      type: "jobSearch",
      ...
      description:
        "Master behavioral and technical interviews with comprehensive preparation and mock interview sessions.",
    ...
    },
    {
      ...
      description:
        "Learn how to tailor your applications, follow up effectively, and stand out in the application process.",
      icon: "M13 10V3L4 14h7v7l9-11h-7z",
    },
  ],
  WhyMe: [
  ...
  WhyMeFeatures: [
    {
      ...
      description:
        "Your success is my priority! I'm dedicated to providing the tools, advice, and mentorship needed to help you reach your full potential and achieve your goals.",
    ...
    },
    {
      ...
      description:
        "I'm committed to guiding you every step of the way, offering continuous support, resources, and regular check-ins to keep you motivated and on track.",
    ...
    },
    {
      ...
      description:
        "From professional resume writing to LinkedIn optimization, interview coaching, and customer success consulting, I offer a full suite of services designed to help you thrive in your career and achieve your professional goals.",
    ...
    },
    {
      ...
      description:
        "With 4+ years of experience in Customer Success and firsthand experience navigating the job application and interview process, I've learned from my own mistakes. Through conversations with many professionals, I've identified the key areas where people often need to tweak their approach to succeed.",
  ...
  HowItWorksSteps: [
    {
      ...
      subtitle:
        "Reach out to me and tell me what you're looking for. Whether it's career guidance, resume writing, LinkedIn help, or customer success consulting, I'll ask a few questions to understand your specific needs and challenges. I'll get back to you quickly with the next steps.",
      order: 1,
    },
    {
      type: "howItWorks",
      ...
      subtitle:
        "After understanding your needs, I will present a customized action plan for you, along with clear pricing for the services you require. You'll then choose the plan that works best for you, and once you're ready, you can make the payment to get started.",
      order: 2,
    },
    {
      type: "howItWorks",
      ...
      subtitle:
        "After payment, I'll begin working on the service you've selected, whether it's crafting your resume, optimizing your LinkedIn profile, or developing a customer success strategy. You'll receive quality work that aligns with your goals and expectations.",
      order: 3,
    },
    {
      type: "howItWorks",
      ...
      subtitle:
        "I believe in your long-term success. After the initial delivery, I'll provide continuous support, check-ins, and any necessary adjustments to ensure that you stay on track and feel confident in your progress.",
      order: 4,
    },
    {
      type: "howItWorks",
      ...
      subtitle:
        "Your experience and satisfaction matters the most to me. I offer up to 3 revisions to make sure everything is just right. We'll work together to refine the final product until it perfectly reflects your vision and goals.",
      order: 5,
    },
  ],
  PricingHeader: [
  ...
  PricingTiers: [
    {
      ...
      price: "$299",
      description:
        "Get a professionally written resume that highlights your achievements and helps you stand out in the job market. I'll work with you to create a compelling resume that showcases your experience and gets you noticed by recruiters.",
      features: [
      ...
      buttonText: "Linkedin",
      link: "https://www.linkedin.com/in/srinidhinarayana21/",
      href: "/contact",
      featured: false,
    },
    {
      id: "customer-success-consulting",
      name: "Customer Success Consulting",
      price: "$599",
      description:
        "As a Customer Success consultant, I understand the critical challenges startups face—reducing churn, improving retention, and scaling CS operations efficiently. Many startups struggle with these issues, but with the right strategy and processes, you can keep customers happy, engaged, and loyal without overwhelming your team.",
      features: [
  ...
  Writing: [
    {
      ...
      description:
        "Struggling to craft the perfect content that builds authority and engagement? I provide expert writing services tailored to your professional and business needs.",
      images: [
        "/images/writing-service.png",
        "/images/shutter-speed-UY6SV10HQR0-unsplash.jpg",
      ],
    },
  ],
  WritingServices: [
    {
      ...
      description:
        "Craft compelling, insightful, and SEO-friendly blogs and articles that position you/your organization as a thought leader in your industry. Whether it's customer success, career growth, or business strategy, I create content that engages, informs, and converts.",
    },
    {
      type: "writing",
      title: "Linkedin Ghostwriting",
      description:
        "Strengthen your personal brand and expand your influence on LinkedIn with expertly crafted posts, articles, and thought leadership content. I help you share your expertise, tell your story, and attract the right audience—without the hassle of writing yourself.",
    },
    {
      type: "writing",
      title: "Customer Success Case Studies",
      description:
        "Highlight your wins and build credibility with well-structured, impactful case studies. I craft compelling success stories that showcase your business's value, helping you attract new clients, demonstrate ROI, and establish trust.",
    },
  ],
  TestimonialsHeader: [
    {
  ...
  Testimonials: [
    {
      id: "testimonial-1",
      quote:
        "She is really good in resume writing and communicates very well. I would highly recommend her. Thank you.",
